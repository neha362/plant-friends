...
"[project]/plant-friends/node_modules/.pnpm/web-vitals@2.1.4/node_modules/web-vitals/dist/web-vitals.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var e, t, n, i, r = function r(e, t) {
    ...
    var n, i = v(), o = r("FCP"), f = function f(e) {
...
}, p = !1, l = -1, h = function h(e, t) {
    p || (d(function(e) {
        l = e.value;
    }), p = !0);
    var n, i = function i(t) {
        l > -1 && e(t);
    }, f = r("CLS", 0), s = 0, m = [], v = function v(e) {
        if (!e.hadRecentInput) {
            var _$t = m[0], i = m[m.length - 1];
            s && e.startTime - i.startTime < 1e3 && e.startTime - _$t.startTime < 5e3 ? (s += e.value, m.push(e)) : (s = e.value, m = [
                e
    ...
    var s, m = v(), d = r("FID"), p = function p(e) {
    ...
    var n, i = v(), f = r("LCP"), s = function s(e) {
        var _$t = e.startTime;
        _$t < i.firstHiddenTime && (f.value = _$t, f.entries.push(e), n());
    ...
    t = function t() {
        try {
            var t = performance.getEntriesByType("navigation")[0] || function() {
                var _$e = performance.timing, t = {
                    entryType: "navigation",
                    startTime: 0
                };
                for(var n in _$e)"navigationStart" !== n && "toJSON" !== n && (t[n] = Math.max(_$e[n] - _$e.navigationStart, 0));
                return t;
            }();
...
//# sourceMappingURL=10d89_web-vitals_dist_web-vitals_ff937fb3.js.map